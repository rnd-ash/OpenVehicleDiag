...
window.onload = function () {
  ...
  console.log(dev_capabilities); // CAN Protocols

  set_bool(document.getElementById('prot-can'), "CAN", dev_capabilities['can']);
  set_bool(document.getElementById('prot-iso15765'), "ISO15765", dev_capabilities['iso15765']); // K-Line Protocols

  set_bool(document.getElementById('prot-iso9141'), "ISO9141", dev_capabilities['iso9141']);
  set_bool(document.getElementById('prot-iso14230'), "ISO14230", dev_capabilities['iso14230']); // J1850 Protocols

  set_bool(document.getElementById('prot-j1850vpw'), "J1850 VPW", dev_capabilities['j1850vpw']);
  set_bool(document.getElementById('prot-j1850pwm'), "J1850 PWM", dev_capabilities['j1850pwm']); // SCI Protocols
  ...
  set_batt_voltage(); // Display battery voltage every 2 seconds
